...
import { animate, timeline as timeline2, stagger } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { stagger as stagger2 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate2, stagger as stagger3, inView } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { timeline as timeline3, inView as inView2 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate3 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate4 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { Delegate as Delegate2 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate5 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { Delegate as Delegate3 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { PhotoSwipeLightbox } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//zaryamoda.pl/cdn/shop/t/4/assets/photoswipe.min.js?v=117345165216443954311777740079"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { inView as inView3 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          ...
          <path d="M18.578 32.629a.375.375 0 0 1-.578-.316V15.687c0-.297.328-.476.578-.316l12.931 8.314c.23.147.23.483 0 .63L18.578 32.63Z" fill="#677279"/>
          <path d="M24 .5C36.979.5 47.5 11.021 47.5 24S36.979 47.5 24 47.5.5 36.979.5 24 11.021.5 24 .5Z" stroke="#677279" stroke-opacity=".12"/>
        </svg>
      `));
    }
  }
...
import { timeline as timeline6 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate8 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate9 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
import { animate as animate10, inView as inView4 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
...
// js/theme.js
import { Delegate as Delegate4 } from "//zaryamoda.pl/cdn/shop/t/4/assets/vendor.min.js?v=56430842210900357591777740078";
(() => {
